...
\begin{onecolentry}
    Hello there! a developer with \textasciitilde3 years of experience in tech, working with \textbf{Python} for \textbf{automation}, \textbf{API development}, and \textbf{backend systems} using \textbf{Python (FastAPI, Flask, Django)} or \textbf{Node.js}. On the \textbf{frontend}, I build applications with \textbf{TypeScript} and \textbf{Node.js}, leveraging frameworks like \textbf{React} and \textbf{Next.js}. I also have experience in \textbf{data scraping}, building \textbf{data pipelines} for \textbf{ML models}, and \textbf{fine-tuning LLMs} to enhance \textbf{AI-driven applications}.  

    I actively contribute to \textbf{open-source projects} to refine my skills and stay ahead of \textbf{emerging technologies}. My \textbf{personal projects} always keep me on my toes to implement \textbf{new technologies}. I’m always looking to bring a \textbf{fresh perspective} to projects, approaching problems from \textbf{new angles} to create more \textbf{innovative} and \textbf{effective solutions}.

    If this aligns with your needs, I'd love to connect for an interview and discuss how we can help each other grow.
\end{onecolentry}
